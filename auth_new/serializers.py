...
class PermanentTokenINFO(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'token', 'username', 'expire_date', 'create_date', 'lastest_date', 'invoke_count', 
                   'invoke_success_count', 'lastest_success_date', 'max_invoke', 'invoke_rule_ids', 'is_validate')
