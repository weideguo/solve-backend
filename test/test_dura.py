...
if __name__ == "__main__":
    ...
    solve_dura.dura.real_load(redis_manage_client, "yyy", {"__pid": "0"})
    ...
    solve_dura.dura.get_collection_name(
        "log_job_5da525ec374011ea8abd000c295dd589", redis_log_client
    )
    ...
    solve_dura.is_job_finish(
        [
            "log_target_b14c00b2374011eabd2c000c295dd589",
            "log_target_b1526c0e374011eabd2c000c295dd589",
        ],
        [
            "sum_b14c00b2374011eabd2c000c295dd589",
            "sum_b1526c0e374011eabd2c000c295dd589",
        ],
    )

    solve_dura.expire("log_job_5da525ec374011ea8abd000c295dd589")

    solve_dura.get_key_info_from_mongo(
        redis_log_client, key="log_job_5da525ec374011ea8abd000c295dd589"
    )
    solve_dura.get_key_info_from_mongo(
        redis_tmp_client, pattern="session.*_5da525ec374011ea8abd000c295dd589"
    )
